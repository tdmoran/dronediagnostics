  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 lg:space-y-8">
      ...
      <div className="page-header">
        ...
        <p className="text-[#8c8c8c] mt-2 text-sm lg:text-base">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        {features.map((feature) => (
          <Link
            key={feature.href}
            href={feature.href}
            className={`group bg-[#1f1f1f] rounded-[4px] border border-[#333] p-5 lg:p-6 transition-all duration-200 hover:bg-[#242424] ${feature.color} touch-manipulation`}
          >
            <div className="flex items-start justify-between mb-4">
              <div className="p-3 bg-[#242424] rounded-[4px] group-hover:bg-[#333] transition-colors">
                {feature.icon}
              </div>
              <ChevronRight className="w-5 h-5 text-[#8c8c8c] group-hover:text-[#f2f2f2] transition-colors" />
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
          <ol className="space-y-3 text-gray-400">
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#ffbb00] text-[#141414] text-sm flex items-center justify-center font-medium">
                1
              </span>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="flex items-center gap-1">
                  <kbd className="px-2 py-1 bg-[#333] rounded text-xs">⌘</kbd>
                  <kbd className="px-2 py-1 bg-[#333] rounded text-xs">K</kbd>
                </span>
              </div>
              <div className="flex items-center justify-between">
                ...
                <span className="flex items-center gap-1">
                  <kbd className="px-2 py-1 bg-[#333] rounded text-xs">⌘</kbd>
                  <kbd className="px-2 py-1 bg-[#333] rounded text-xs">⇧</kbd>
                  <kbd className="px-2 py-1 bg-[#333] rounded text-xs">C</kbd>
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-400">Arm/Disarm</span>
                <span className="flex items-center gap-1">
                  <kbd className="px-2 py-1 bg-[#333] rounded text-xs">Space</kbd>
                </span>
              </div>
              <div className="flex items-center justify-between">
